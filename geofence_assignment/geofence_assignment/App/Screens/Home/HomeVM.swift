...
protocol HomeOutput {
    ...
    var onStartEnterRegionAction: EnterRegionObservable { get }
    var onStartExitRegionAction: ExitRegionObservable { get }
}
